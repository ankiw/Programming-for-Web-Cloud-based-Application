...
system.register(function input( settings, dom, $){
    var keys = {
        37:'KEY_LEFT',
        38:'KEY_UP',
        39:'KEY_RIGHT',
    ...
    function handleClick(event, control, click ){
        ...
        // jewel coordinates
        posX = Math.floor( relX / rect.width * settings.cols );
        PosY = Math.floor( relY / rect.height * settings.rows );
        // trigger functions bound to action
        trigger( action, posX, PosY );
